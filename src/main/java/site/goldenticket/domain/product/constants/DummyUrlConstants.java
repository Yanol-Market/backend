...
public class DummyUrlConstants {
    ...
    public static final String RESERVATION_ENDPOINT = "/dummy/reservation/{reservationId}";
    public static final String RESERVATION_UPDATE_STATUS_ENDPOINT = "/dummy/reservation/update-status/{reservationId}";
}
